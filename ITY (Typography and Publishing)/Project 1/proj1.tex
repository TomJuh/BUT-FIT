...
\hspace{0.5cm}Čím více \emph{druhů}, \textbf{řezů}, {\scriptsize{velikostí}}, \textcolor{red}{barev} písma a~jiných \textsc{efektů} použijeme, tím \texttt{profesionálněji} bude {\Large \fontfamily{pzc}\selectfont dokument}  vypadat.
